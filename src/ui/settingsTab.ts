import { DEFAULT_SETTINGS } from "./../constants/settingsConstants.js"
...
export class ChartSettingTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    containerEl.createEl("h2", { text: "Settings - Obsidian Chartz" })
    ...
    new Setting(containerEl)
      ...
      .addButton((bt) => {
        bt.buttonEl.outerHTML = `<a href="https://ko-fi.com/mrtnbroder"><img src="https://uploads-ssl.webflow.com/5c14e387dab576fe667689cf/61e11e22d8ff4a5b4a1b3346_Supportbutton-1.png"></a>`
      })
