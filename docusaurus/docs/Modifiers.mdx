...
Can set the min and max of the respecitve axis (like: `xMax` or `yMin`). `Min` will override beginAtZero. Use `rMax` to set the max for radar and polar area charts.
